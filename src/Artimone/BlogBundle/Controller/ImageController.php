...
use Artimone\BlogBundle\Form\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('ArtimoneBlogBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('Artimone\BlogBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('Artimone\BlogBundle\Form\ImageType', $image);
